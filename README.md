...
## **데이터 선정이유:**
건강한 음주생활을 위해 음주와 학습에 관련된 영향을 파악하기 위해서 선정했다.
...
**서예찬**
: 데이터를 그래프로 시각화 하는 과정에서 범주의 순서가 제멋대로 수정되거나 그래프로 출력하는 과정에서 데이터가 사라지는 등의 일이 있었는데 이번 프로젝트를 통해 부족한부분을 공부할수있는 계기가 된것같습니다.
